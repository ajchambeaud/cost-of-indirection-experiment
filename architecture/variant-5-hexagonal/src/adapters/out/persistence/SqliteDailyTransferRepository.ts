...
import { DailyTransferRepository } from "../../../domain/ports/out/DailyTransferRepository";

interface DailyTransferRow {
  total: number;
}

export class SqliteDailyTransferRepository implements DailyTransferRepository {
